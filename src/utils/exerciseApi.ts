...
const EXERCISE_MAPPING: Record<string, string> = {
  ...
  'Cable Curls': 'Cable_Hammer_Curls_-_Rope_Attachment',
  ...
  'Reverse Flyes': 'Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench',
  ...
  'الضغط الماسي': 'Close-Grip_Push-Up_off_of_a_Dumbbell',
  'ضغط البنش': 'Barbell_Bench_Press_-_Medium_Grip',
  'ضغط البار': 'Barbell_Bench_Press_-_Medium_Grip',
  'الضغط المائل بالبار': 'Barbell_Incline_Bench_Press_-_Medium_Grip',
  ...
  'فتح الكتف الخلفي': 'Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench',
  'الفتح العكسي': 'Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench',
...
const ALTERNATIVE_MAPPINGS: Record<string, string[]> = {
  ...
  'Cable_Face_Pull': ['Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench', 'Side_Lateral_Raise'],
  ...
  'Close-Grip_Push-Up_off_of_a_Dumbbell': ['Pushups', 'Incline_Push-Up'],
  'Lying_T-Bar_Row': ['Bent_Over_Barbell_Row', 'Seated_Cable_Rows'],
  'Barbell_Incline_Bench_Press_-_Medium_Grip': ['Incline_Dumbbell_Press', 'Dumbbell_Bench_Press'],
  'Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench': ['Side_Lateral_Raise', 'Dumbbell_Flyes'],
  'Cable_Hammer_Curls_-_Rope_Attachment': ['Barbell_Curl', 'Hammer_Curls'],
};
